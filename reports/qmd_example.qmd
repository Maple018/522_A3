...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-all}

We can see from @fig-all that Ontario, Saskatchewan and Alberta 
...
Additionally, note that in @tbl-sd we consider the sample standard deviation of the number of horses during the same time span as @fig-all.

![Horse populations for the province with the largest standard deviation.](../results/horse_pops_plot_largest_sd.png){#fig-largest out-width="65%"}

In @fig-largest we zoom in and look at the province of {{largest_sd}}, which had the largest spread of values in terms of standard deviation.
